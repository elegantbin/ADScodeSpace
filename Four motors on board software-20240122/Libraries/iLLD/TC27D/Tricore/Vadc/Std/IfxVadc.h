...
IFX_INLINE void IfxVadc_stopBackgroundScan(Ifx_VADC *vadc)
{
    vadc->BRSMR.B.LDEV = 0;     /* execute Load event to stop the conversion */
}
...
IFX_INLINE void IfxVadc_stopScan(Ifx_VADC_G *group)
{
    group->ASMR.B.LDEV = 0;     /* set Load event.  conversion will stop */
}
