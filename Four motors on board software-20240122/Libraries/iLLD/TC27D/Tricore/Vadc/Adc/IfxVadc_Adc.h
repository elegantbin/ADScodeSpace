...
IFX_INLINE void IfxVadc_Adc_stopBackgroundScan(IfxVadc_Adc *vadc)
{
    IfxVadc_stopBackgroundScan(vadc->vadc);
}
...
IFX_INLINE void IfxVadc_Adc_stopScan(IfxVadc_Adc_Group *group)
{
    IfxVadc_stopScan(group->group);
}
