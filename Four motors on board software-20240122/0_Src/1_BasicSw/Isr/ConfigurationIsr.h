 ...
 * \{
 */
#define ISR_PRIORITY_ATOM_PWM_VPHASE  19                                   /* Interrupt priority number                        */
#define ISR_PRIORITY_TOM1_TIMER       21
...
#define ISR_PRIORITY_CAN_debug_TX         8                           /* Define the CAN TX interrupt priority              */
