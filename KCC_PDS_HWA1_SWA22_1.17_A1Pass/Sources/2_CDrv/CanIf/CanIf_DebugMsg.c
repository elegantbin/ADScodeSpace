...
extern sAntiPinch_t g_antipinch;
 ...
 void CanIf0_transmitDebugMsg3(void)
 {
     ...
     u16SendVar  = (uint16_t)(i16ApAdapt);
	 tx_msg->data[6] = (uint8_t)(u16SendVar);
 ...
 {   
	 ...
	 u16SendVar = g_antipinch.lu16ApCalCounter;
	// tx_msg->data[5] = g_RecvMsg_CAN0.data[5];
	 tx_msg->data[6] = (uint8_t)u16SendVar;
	 tx_msg->data[7] = g_RecvMsg_CAN0.data[7];
 ...
 void CanIf0_transmitDebugMsg5(void)
 {
	 ...
	 uint16_t sendVar;
	 extern int16_t g_i16DoorDutyPercent,g_i16DoorDutyPercent_1;
	 ...
	 sendVar = g_i16DoorDutyPercent_1;
